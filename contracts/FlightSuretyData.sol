...
contract FlightSuretyData {
    ...
    *
    */   
    function buyInsurance (address _airline, string _flight, uint256 _departure)
        requireIsOperational
        external
        payable
    {
        ...
        emit InsurancePurchased(msg.sender, _flight);
    }
    ...
    */
        ...
        external
    {
        ...
        emit PayoutToInsuree(msg.sender, _flight);
    }
